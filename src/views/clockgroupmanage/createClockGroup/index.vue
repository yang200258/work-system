            ...
            <div class="first" v-if="active === 0">
                ...
                <div class="worktype">
                    ...
                    <div class="worktype-content">
                        <clock-count v-for="(item,i) in countData" :key="i" :countData="item" :workType="workType" :class="workType.num == i ? 'isActive' : ''"></clock-count>
                    </div>
                </div>
                <!-- 工作日设置 -->
                <div class="day">
                    ...
                    <div class="workday">
                        <el-checkbox-group v-model="workday" @change="handleCheckedCitiesChange">
                ...
                <div class="rest">
                    ...
                    <el-checkbox v-model="autorest" class="autorest">法定节假日自动排休</el-checkbox>
